...
mod tests {
    ...
    const PINK: Lab = Lab { l: 66.63909, a: 52.251427, b: 14.860654 };

    static COLOURS: [([u8; 3], Lab); 17] = [
        ([253, 120, 138], PINK),

        ([127,   0,   0], Lab { l: 25.301395, a: 47.77433, b: 37.75405 }),
        ([  0, 127,   0], Lab { l: 45.87666, a: -51.40707, b: 49.61558 }),
        ([  0,   0, 127], Lab { l: 12.808655, a: 47.23452, b: -64.33745 }),
        ([  0, 127, 127], Lab { l: 47.8919, a: -28.683693, b: -8.42911 }),
        ([127,   0, 127], Lab { l: 29.52658, a: 58.595745, b: -36.281406 }),
        ([255,   0,   0], Lab { l: 53.240784, a: 80.09249, b: 67.203186 }),
        ([  0, 255,   0], Lab { l: 87.73472, a: -86.18272, b: 83.17931 }),
        ([  0,   0, 255], Lab { l: 32.29701, a: 79.187515, b: -107.86016 }),
        ([  0, 255, 255], Lab { l: 91.11321, a: -48.087536, b: -14.131188 }),
        ([255,   0, 255], Lab { l: 60.324203, a: 98.23435, b: -60.824905 }),
        ...
        ([196, 196, 196], Lab { l: 79.15698, a: 0.000029802322, b: -0.000011920929 }),
    ...
    fn test_distance() {
        ...
        assert_eq!(PINK.squared_distance(&ugly_websafe_pink), 254.68913);
    }
