...
pub(crate) const S_0: f32 = 0.003_130_668_442_500_564;
pub(crate) const E_0_255: f32 = 3294.6 * S_0;

// Generated by srgb-matrices.py
const WHITE_X: f32 = 0.950_449_218_275_099_1;
const WHITE_Z: f32 = 1.088_916_648_430_471_5;
...
fn rgb_to_xyz(r: u8, g: u8, b: u8) -> [f32; 3] {
    rgb_to_xyz_inner(f32::from(r), f32::from(g), f32::from(b))
}
...
fn rgb_to_xyz_inner(r: f32, g: f32, b: f32) -> [f32; 3] {
    ...
    let x = mul3(
        ...
        g,
        b,
        0.412_410_846_488_538_8,
        0.357_584_567_852_951_9,
        0.180_453_803_933_608_33,
    );
    let y = mul3(
        r,
        g,
        b,
        0.212_649_342_720_652_83,
        0.715_169_135_705_903_8,
        0.072_181_521_573_443_33,
    );
    let z = mul3(
        r,
        g,
        b,
        0.019_331_758_429_150_258,
        0.119_194_855_950_983_97,
        0.950_390_034_050_337_3,
    );
...
fn xyz_to_rgb_normalized(xyz: [f32; 3]) -> [f32; 3] {
    ...
    let r = mul3(
        ...
        y,
        z,
        3.240_812_398_895_283,
        -1.537_308_445_629_813_6,
        -0.498_586_522_906_966_6,
    );
    let g = mul3(
        x,
        y,
        z,
        -0.969_243_017_008_640_7,
        1.875_966_302_908_574_2,
        0.041_555_030_856_685_64,
    );
    let b = mul3(
        x,
        y,
        z,
        0.055_638_398_436_112_804,
        -0.204_007_460_932_413_62,
        1.057_129_570_286_143_4,
    );
...
mod tests {
    ...
    static COLOURS: [([u8; 3], Lab, LCh); 17] = [
        ([253, 120, 138],
         PINK,
         LCh { l: 66.637_695, c: 54.321_777, h: 0.277_060_2 }),

        ([127,   0,   0],
         Lab { l: 25.299_877, a: 47.77421, b: 37.752_514 },
         LCh { l: 25.299_877, c: 60.890_293, h: 0.668_753_86 }),
        ([  0, 127,   0],
         Lab { l: 45.87715, a: -51.405_922, b: 49.61748 },
         LCh { l: 45.87715, c: 71.445_526, h: 2.373_896 }),
        ([  0,   0, 127],
         Lab { l: 12.809_523, a: 47.237_186, b: -64.33636 },
         LCh { l: 12.809_523, c: 79.81553, h: -0.937_469_66 }),
        ([  0, 127, 127],
         Lab { l: 47.892_532, a: -28.680_845, b: -8.428_156 },
         LCh { l: 47.892_532, c: 29.893_557, h: -2.855_778_2 }),
        ([127,   0, 127],
         Lab { l: 29.525_677, a: 58.597_298, b: -36.28323 },
         LCh { l: 29.525_677, c: 68.92109, h: -0.554_415 }),
        ([255,   0,   0],
         Lab { l: 53.238_235, a: 80.09231, b: 67.202_095 },
         LCh { l: 53.238_235, c: 104.55094, h: 0.698_107_3 }),
        ([  0, 255,   0],
         Lab { l: 87.73554, a: -86.18078, b: 83.18251 },
         LCh { l: 87.73554, c: 119.776_695, h: 2.373_896 }),
        ([  0,   0, 255],
         Lab { l: 32.298_466, a: 79.192, b: -107.858_345 },
         LCh { l: 32.298_466, c: 133.8088, h: -0.937_469_66 }),
        ([  0, 255, 255],
         Lab { l: 91.11428, a: -48.08274, b: -14.12958 },
         LCh { l: 91.11428, c: 50.115_814, h: -2.855_778_7 }),
        ([255,   0, 255],
         Lab { l: 60.322_693, a: 98.23698, b: -60.827_957 },
         LCh { l: 60.322_693, c: 115.544_556, h: -0.554_414_87 }),
        ([255, 255,   0],
         Lab { l: 97.139, a: -21.556_675, b: 94.48001 },
         LCh { l: 97.139, c: 96.90801, h: 1.795_117_6 }),
        ...
        ([127, 127, 127],
         Lab { l: 53.192_772, a: 0.0, b: 0.0 },
         LCh { l: 53.192_772, c: 0.0, h: 0.0 }),
        ([196, 196, 196],
    ...
    fn test_lch_to_lab() {
        ...
        fn round(vec: &mut Vec<Lab>) {
            for lab in vec.iter_mut() {
                lab.a = (lab.a * 100_000.0).round() / 100_000.0;
                lab.b = (lab.b * 100_000.0).round() / 100_000.0;
            }
        }
        round(&mut expected);
        round(&mut actual);
    ...
    fn test_distance() {
        ...
        assert!(254.65927 - PINK.squared_distance(&ugly_websafe_pink) <= f32::EPSILON);
    }
    ...
    fn test_grey_error() {
        ...
        for i in 0..=255_u32 {
            ...
            if lab.a != 0.0 || lab.b != 0.0 {
                error = (f64::from(lab.a)).mul_add(f64::from(lab.a), error);
                error = (f64::from(lab.b)).mul_add(f64::from(lab.b), error);
                count += 1;
            }
        }
        assert_eq!((23, 10.627_054_791_711_998), (count, error * 1e9));
    }
}
